  ...
  <div class="w-full h-full">
    <div class="relative flex items-center justify-center min-h-screen sm:pt-0">
      ...
      <div class="absolute top-0 left-0 w-full p-6 flex items-center flex-col justify-center z-0 short:hidden">
        <img src="/shelfdrive-logo.svg" class="h-20 w-20 mb-3" />
        <h1 class="text-2xl font-semibold">ShelfDrive</h1>
        <p class="text-sm text-fg-muted mt-1">Connect your self-hosted audiobook library</p>
      </div>
      <p class="hidden absolute short:block top-1.5 left-12 p-2 text-xl">ShelfDrive</p>
    ...
    <div class="flex items-center justify-center pt-4 fixed bottom-4 left-0 right-0">
      <a href="https://github.com/JediBrooker/ShelfDrive" target="_blank" class="text-sm pr-2">Source and license notices</a>
      <a href="https://github.com/JediBrooker/ShelfDrive" target="_blank"
